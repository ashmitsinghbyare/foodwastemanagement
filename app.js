...
// Configure express app and start server
const configureAndStartApp = async () => {
  try {
    // Connect to MongoDB first
    await connectDB();
    
    console.log('MongoDB connected, configuring session store...');
    ...
    console.error('Failed to configure and start application:', err);
    // Wait 5 seconds before retrying
    console.log('Retrying in 5 seconds...');
    setTimeout(configureAndStartApp, 5000);
  }
};
